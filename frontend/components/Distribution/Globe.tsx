...
export const Globe = (props) => {
    ...
    const createGlobe = ()=> {
        ...
        console.log(props.distributionShape.type)

        const distributionShape = topojson.feature(props.distributionShape, props.distributionShape.objects['afrikanischer-elefant']);
...
//the scale corrsponds to the radius more or less so 1/2 width
        ...
        var c = (canvas.node() as HTMLCanvasElement).getContext("2d");
        ...
        var selectedCountryFill = "#007ea3",
            ...
            landFill = "#FBF8F3",
            seaFill = "#8AB4F8",
            distributionFill = "#00ff00";
        var startCountry = "Germany";
        var endCountry = "Angola";
        ...
        function redraw(){
            ...
            for(let i = 0, x = distributionShape.features.length; i < x; i += 1){

                c.fillStyle = distributionFill, c.beginPath(), path(distributionShape.features[i]), c.fill();
            }
